class ParseIntoSqls {
  ...
  'token': 'CREATE TABLE token (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,token TEXT)',
  ...
  'user': 'CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT,aiid INTEGER,uuid TEXT,created_at INTEGER,updated_at INTEGER,username TEXT,password TEXT,email TEXT,age INTEGER)',
